                                    ...
                                    <form action="" method="post" onsubmit="return false">
                                        <div class="row" id="row<?php echo $id; ?>">
                                            ...
                                            <div class="4u">
                                                ...
                                                <label id="distributore<?php echo $id; ?>" for="distributore<?php echo $id; ?>" class="text" onclick="document.getElementById('select').value='<?php echo $risultato['nome_distributore']; ?>'>DISTR.&nbsp;:<strong style="color: lightseagreen"><?php echo $risultato['nome_distributore']; ?></strong></label>
