<?php
    ...
    <html>
    <head>
        <title>Area Privata - Ordina</title>
                        ...
                        <form method="get" action="" name="dati_utente" id="dati_utente" target="_parent" onsubmit="return false" >
                            ...
                            <div class="row">
                                <div class="3u">
                                    ...
                                    <input id="locazione" name="locazione" type="text" class="text">
                                ...
                                <div class="2u">
                                    <input id="qtaord" name="qtaord" placeholder="0" type="text" class="text">
                                </div>
                                <div class="2u">
                                    ...
                                    <a href="" class="fa fa-plus" id="ordina" title="Ordina">Ordina</a>
                                </div>
