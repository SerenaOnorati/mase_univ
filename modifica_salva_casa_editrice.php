<?php
    ...
    if(!userIsLoggedIn())
    {
        ...
        if(userHasRole('Amministratore'))
        {
            ...
            $sito_web_casa_editrice = trim($_POST['sito_web']);
            $id_distributore = trim($_POST['id_distributore']);

            //inserimento della nuova news nel db
            try
            {
                $sql = 'UPDATE casa_editrice SET  nome =:nome, sito_web_casa_editrice =:sito_web_casa_editrice, id_distributore =:id_distributore
